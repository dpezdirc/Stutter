...
//==============================================================================
const juce::String StutterAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool StutterAudioProcessor::acceptsMidi() const
{
...
bool StutterAudioProcessor::producesMidi() const
{
...
bool StutterAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double StutterAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int StutterAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int StutterAudioProcessor::getCurrentProgram()
{
    return 0;
}

void StutterAudioProcessor::setCurrentProgram (int index)
{
}

const juce::String StutterAudioProcessor::getProgramName (int index)
{
    return {};
}

void StutterAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
//==============================================================================
bool StutterAudioProcessor::hasEditor() const
{
